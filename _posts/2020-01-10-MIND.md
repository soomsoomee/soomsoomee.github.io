...
'Pop Your Filter Bubble' 프로젝트를 진행하면서 [MIND: A Large-scale Dataset for News Recommendation](https://paperswithcode.com/paper/mind-a-large-scale-dataset-for-news) 논문을 리뷰하게 되었다. 
